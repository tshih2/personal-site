 ...
 * 用法:
 *   <div id="app"></div>
 *   <script src="case-study-template.js"></script>
 *   <script src="data-xxx.js"></script>
  ...
  return `
    <div id="fold" class="flex flex-col lg:flex-row lg:h-screen lg:w-screen">
      ...
      <div class="intro-col lg:h-full border-b lg:border-b-0 lg:border-r border-black/10 flex flex-col px-8 lg:flex-[0_0_20.8333%] lg:min-w-[260px]">
        ...
        <h1 class="mt-12 font-unbounded font-extrabold text-[2.25rem] sm:text-[2.75rem] leading-[1.1] tracking-[-0.034em]">${data.title}</h1>
