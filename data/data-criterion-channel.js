const CASE_STUDY_DATA = {
  title: 'The Criterion Channel Brand Identity',

  category: '3D Motion · Brand Identity',

  intro: 'A seven-week brand identity project translating The Criterion Channel\'s commitment to preserving classic cinema through modern technology into a 3D motion system about growth, evolution, and continuity.',
  ...
  overview: {
    content: [
      '<strong>Overview</strong><br><br>For this individual class project, I reimagined The Criterion Channel\'s brand identity through a logo animation and motion graphic. I was responsible for the concept, visual direction, 3D production, animation, and post-production.',
  ...
  sections: [
    {
      title: 'Finding the Brand in Its Roots',
      content: [
        '<strong>From preservation to visual concept</strong><br><br>I was drawn to The Criterion Channel because it uses contemporary technology to restore and renew classic cinema. Today\'s films and filmmaking techniques are built on these earlier works; the classics are the roots from which cinema continues to grow.',
        '<strong>Roots, DNA, and inheritance</strong><br><br>I explored roots and DNA as metaphors for continuity. Rather than treating preservation as something static, I framed it as an active cycle of growth, innovation, elimination, and evolution—each generation carrying part of what came before into a new form.',
    ...
    {
      title: 'Turning an Idea into Motion',
      content: [
        '<strong>A four-stage transformation</strong><br><br>The animation follows a deliberate sequence: growth → evolution → fusion → logo. The form begins as an organic system, develops through successive states, then converges into a recognizable brand mark. This progression connects Criterion\'s cinematic roots with its role in carrying film culture forward.',
        '<strong>Exploring form through movement</strong><br><br>I used Cinema 4D to test how segmented, film-like structures could grow, combine, and transform. Redshift helped define the luminous gold material and cinematic lighting, while After Effects was used to refine timing and complete the motion piece.',
    ...
    },
    {
      ...
      content: [
        '<strong>Final direction</strong><br><br>The project resulted in a logo animation and motion graphic built around one cohesive idea: cinema survives by continually growing from, transforming, and recombining its foundations. The final style frames bring together the segmented forms, luminous gold palette, and cinematic sense of anticipation.',
        '<strong>An idea stronger than its execution</strong><br><br>I remain proud of the conceptual direction, but the final execution did not reach the level of polish I originally envisioned. Personal circumstances, Cinema 4D\'s learning curve, and limited hardware reduced the time and rendering capacity available during the seven-week project.',
